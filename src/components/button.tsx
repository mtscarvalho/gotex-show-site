...
const buttonLero = tv({
  ...
  variants: {
    ...
    variant: {
      ...
      outline: "bg-default border border-default text-default hover:bg-brand-secondary hover:text-brand-secondary disabled:bg-disabled disabled:border-disabled disabled:border disabled:text-on-disabled",
